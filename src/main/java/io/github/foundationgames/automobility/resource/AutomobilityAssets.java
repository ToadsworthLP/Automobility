...
public enum AutomobilityAssets {;
    ...
    public static void setup() {
        ...
        for (Direction dir : AUtils.HORIZONTAL_DIRS) {
            slopedDashPanel.put("half=bottom,left=false,right=false,facing="+ dir, JState.model(Automobility.id("block/dash_panel_slope_single_bottom")).y((int)dir.asRotation()));
            slopedDashPanel.put("half=bottom,left=true,right=false,facing="+ dir, JState.model(Automobility.id("block/dash_panel_slope_left_bottom")).y((int)dir.asRotation()));
            slopedDashPanel.put("half=bottom,left=false,right=true,facing="+ dir, JState.model(Automobility.id("block/dash_panel_slope_right_bottom")).y((int)dir.asRotation()));
            slopedDashPanel.put("half=bottom,left=true,right=true,facing="+ dir, JState.model(Automobility.id("block/dash_panel_slope_center_bottom")).y((int)dir.asRotation()));
            slopedDashPanel.put("half=top,left=false,right=false,facing="+ dir, JState.model(Automobility.id("block/dash_panel_slope_single_top")).y((int)dir.asRotation()));
            slopedDashPanel.put("half=top,left=true,right=false,facing="+ dir, JState.model(Automobility.id("block/dash_panel_slope_left_top")).y((int)dir.asRotation()));
            slopedDashPanel.put("half=top,left=false,right=true,facing="+ dir, JState.model(Automobility.id("block/dash_panel_slope_right_top")).y((int)dir.asRotation()));
            slopedDashPanel.put("half=top,left=true,right=true,facing="+ dir, JState.model(Automobility.id("block/dash_panel_slope_center_top")).y((int)dir.asRotation()));
        }
        PACK.addBlockState(new JState().add(slopedDashPanel), Automobility.id("dash_panel_slope"));

        var steepDashPanel = JState.variant();
        for (Direction dir : AUtils.HORIZONTAL_DIRS) {
            steepDashPanel.put("left=false,right=false,facing="+ dir, JState.model(Automobility.id("block/steep_dash_panel_slope_single")).y((int)dir.asRotation()));
            steepDashPanel.put("left=true,right=false,facing="+ dir, JState.model(Automobility.id("block/steep_dash_panel_slope_left")).y((int)dir.asRotation()));
            steepDashPanel.put("left=false,right=true,facing="+ dir, JState.model(Automobility.id("block/steep_dash_panel_slope_right")).y((int)dir.asRotation()));
            steepDashPanel.put("left=true,right=true,facing="+ dir, JState.model(Automobility.id("block/steep_dash_panel_slope_center")).y((int)dir.asRotation()));
        }
        PACK.addBlockState(new JState().add(steepDashPanel), Automobility.id("steep_dash_panel_slope"));
